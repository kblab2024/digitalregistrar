...
This repository contains the source code, extraction logic (DSPy signatures), and benchmarking scripts associated with the manuscript: **"Digital Registrar: A Schema-First Framework for Multi-Cancer Privacy-Preserving Pathology Abstraction via Local LLMs"** (Submitted to *Diagnostics*).
